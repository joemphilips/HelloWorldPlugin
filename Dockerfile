...
FROM mcr.microsoft.com/dotnet/sdk:6.0-bullseye-slim-amd64 AS dotnet_publish

WORKDIR /app
ENV DOTNET_CLI_TELEMETRY_OPTOUT 1
# 3. Build
COPY . .
RUN dotnet publish "HelloWorldPlugin.Server/HelloWorldPlugin.Server.csproj" -c Debug \
    -o /app/publish \
...
COPY --from=dotnet_publish /app/publish/greeterd /opt/lightningd/plugins
